...
int main(int argc, char ** argv) {
    ...
    /*
    Matriz original(Matriz(3,3));
    original.setCelda(0,0,1); 
    original.setCelda(0,1,1);
    original.setCelda(0,2,2);
    original.setCelda(1,0,3);
    original.setCelda(1,1,2);
    original.setCelda(1,2,1);
    original.setCelda(2,0,3);
    original.setCelda(2,1,1);
    original.setCelda(2,2,3);
    original.verMatriz();
    Vector vectorElementosMatriz;
