//se tienen que recibir estos parametros para poder trabajar, la idea era usar la longitud del vector para saber cuantas variables de contador de frecuencia hacer
